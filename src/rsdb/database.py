...
e_humidity BOOLEAN NOT NULL,
e_pressure BOOLEAN NOT NULL,
e_battery BOOLEAN NOT NULL,
e_burst_timer BOOLEAN NOT NULL,
e_xdata BOOLEAN NOT NULL,
frequency DECIMAL(4, 1) UNSIGNED NOT NULL,
